...
global.dfail = (type, m, conn, usedPrefix) => {
    const mensajes = {
        rowner: '╮──────────────╭\n│ *هذا الأمر للمطور فقط... واحترم الحدود.*🕴️\n╯──────────────╰',
owner: '╮──────────────╭\n│ *هذا الأمر لا يُنفَّذ إلا بأمر من النجم اليماني.*🥃\n╯──────────────╰',
mods: '╮──────────────╭\n│ *فقط من يحمل ثقة العائلة، يمكنه استخدام هذا.*🔱\n╯──────────────╰',
premium: '╮──────────────╭\n│ *هذا الامتياز لا يُمنح إلا للمختارين.*💎\n╯──────────────╰',
group: '╮──────────────╭\n│ *نفِّذ هذا الأمر داخل الجروب، وليس هنا.*🕶️\n╯──────────────╰',
private: '╮──────────────╭\n│ *تحدث إليّ على انفراد... هنا ليس المكان.*📩\n╯──────────────╰',
admin: '╮──────────────╭\n│ *فقط المسؤولون يملكون صلاحية كهذه.*🎩\n╯──────────────╰',
botAdmin: '╮──────────────╭\n│ *اجعلني مشرفًا أولاً... ثم نتحاور.*⚖️\n╯──────────────╰',
unreg: '╮──────────────╭\n│ *لا أحد يُخاطب المجهول دون تقديم نفسه.*📜\n│ مثال: .تسجيل نجم.20\n╯──────────────╰',
